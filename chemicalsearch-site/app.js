...
function injectStyles() {
  ...
  style.textContent = `
    :root{--bg:#050505;--panel:#111;--panel2:#171717;--ink:#f5f5f5;--muted:#b7b7b7;--line:#333;--line2:#444;--white:#fff;--black:#000;--shadow:0 18px 48px rgba(0,0,0,.45)}*{box-sizing:border-box}html{background:var(--bg)}body{margin:0;background:var(--bg);color:var(--ink);font-family:Arial,Helvetica,sans-serif}button,input,select,textarea{font:inherit}button{cursor:pointer}a{color:#fff}.shell{min-height:100vh;background:radial-gradient(circle at top right,#161616 0,#050505 42%)}.topbar{position:sticky;top:0;z-index:20;background:rgba(0,0,0,.94);backdrop-filter:blur(12px);color:#fff;border-bottom:1px solid var(--line)}.topbar-inner,.emergency-strip-inner,.hero-inner,.main,.footer-inner{width:100%;max-width:1120px;margin:0 auto}.topbar-inner{min-height:60px;padding:10px 16px;display:flex;align-items:center;justify-content:space-between;gap:12px}.brand{display:flex;align-items:center;gap:10px;border:0;background:transparent;color:#fff;text-align:left}.brand-mark{width:38px;height:38px;border-radius:9px;background:#fff;color:#000;display:grid;place-items:center;font-weight:900}.brand-copy{display:grid}.brand-title{font-weight:900}.brand-subtitle{font-size:.8rem;color:var(--muted)}.nav-actions,.form-actions,.quick-searches,.filter-tabs,.card-badges,.detail-actions{display:flex;gap:8px;flex-wrap:wrap;align-items:center}.button{min-height:40px;border:1px solid var(--line2);border-radius:10px;padding:0 13px;font-weight:800;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;background:#1a1a1a;color:#fff}.button.primary{background:#fff;color:#000;border-color:#fff}.button.secondary{background:#111;border-color:#555;color:#fff}.button.compact{min-height:34px;font-size:.9rem}.button:hover,.quick-chip:hover,.filter-chip:hover{transform:translateY(-1px)}.emergency-strip{background:#0b0b0b;border-bottom:1px solid var(--line)}.emergency-strip-inner{padding:8px 16px;display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.hotline{min-height:42px;border-radius:9px;padding:8px 10px;text-decoration:none;color:#fff;display:flex;align-items:center;justify-content:space-between;gap:8px;border:1px solid var(--line2);text-align:left;background:#141414}.hotline.critical{background:#fff;color:#000;border-color:#fff}.hotline.poison,.hotline.neutral{background:#141414;color:#fff}.hotline-label{font-weight:900}.hotline-copy{font-size:.76rem;opacity:.78}.hero{background:#050505;border-bottom:1px solid var(--line)}.hero-inner{padding:16px}.eyebrow{display:inline-flex;align-items:center;min-height:22px;padding:0 9px;border-radius:999px;background:#fff;color:#000;font-size:.7rem;font-weight:900;text-transform:uppercase;letter-spacing:.04em}.hero h1{max-width:780px;margin:8px 0;font-size:clamp(1.45rem,2.6vw,2.25rem);line-height:1.07;color:#fff}.lead{color:var(--muted);line-height:1.4}.hero .lead{max-width:820px;color:#d0d0d0;margin:0}.trust-row{display:flex;gap:6px;flex-wrap:wrap;margin-top:10px}.trust-row span{background:#111;color:#fff;border:1px solid var(--line2);border-radius:999px;padding:4px 9px;font-size:.78rem}.main{padding:14px 16px 28px;display:grid;gap:14px}.panel{background:rgba(17,17,17,.96);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);padding:16px}.search-panel{box-shadow:none;background:#0b0b0b;margin-bottom:14px}.search-row{display:grid;grid-template-columns:1fr auto;gap:10px}.search-input,.field,.textarea{width:100%;min-height:44px;border:1px solid #4a4a4a;border-radius:10px;padding:10px 12px;background:#050505;color:#fff}.search-input::placeholder,.field::placeholder,.textarea::placeholder{color:#7a7a7a}.search-input:focus,.field:focus,.textarea:focus,select:focus{outline:2px solid #fff;outline-offset:1px}.textarea{min-height:100px;resize:vertical}.quick-searches{margin-top:8px}.quick-chip,.filter-chip{min-height:34px;border:1px solid var(--line2);border-radius:999px;background:#111;color:#fff;padding:0 12px;font-weight:800}.filter-chip.is-selected,.quick-chip:hover{background:#fff;color:#000;border-color:#fff}.section-heading,.filter-toolbar,.detail-header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.filter-toolbar{margin-bottom:12px}.sort-control{display:flex;align-items:center;gap:8px;color:var(--muted)}.sort-control select{min-height:36px;border:1px solid var(--line2);border-radius:999px;padding:0 12px;background:#050505;color:#fff}.meta{color:var(--muted);font-size:.92rem;line-height:1.35}.cards{display:grid;gap:10px}.chemical-card{width:100%;border:1px solid var(--line);border-radius:12px;background:#0d0d0d;color:#fff;text-align:left;display:grid;grid-template-columns:8px 1fr;overflow:hidden;box-shadow:0 8px 24px rgba(0,0,0,.28)}.chemical-card:hover{border-color:#fff;background:#151515}.hazard-rail{background:#fff}.hazard-high .hazard-rail,.hazard-extreme .hazard-rail,.hazard-moderate .hazard-rail{background:#fff}.card-content{padding:14px;display:block}.chemical-name{font-size:1.02rem;color:#fff}.risk-pill,.ghs-pill{display:inline-flex;border-radius:999px;padding:4px 8px;font-size:.72rem;font-weight:900;border:1px solid var(--line2)}.risk-low,.risk-moderate,.risk-high,.risk-extreme,.ghs-pill{background:#181818;color:#fff}.card-preview{display:grid;gap:3px;color:#d8d8d8;line-height:1.35}.card-footer{margin-top:8px;display:flex;justify-content:space-between;color:var(--muted);font-size:.86rem}.open-label{color:#fff;font-weight:900}.incident-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.incident-card{border:1px solid var(--line);border-radius:12px;padding:12px;background:#0d0d0d}.incident-card h3,.panel h2{color:#fff}.detail-header{background:#0d0d0d;padding:16px;align-items:center}.detail-title{font-size:clamp(1.55rem,2.4vw,2.25rem);margin:8px 0 6px;color:#fff}.detail-meta{font-size:.95rem;color:#d8d8d8}.hazard-overview{display:grid;grid-template-columns:190px 1fr;gap:12px}.nfpa-card{display:grid;place-items:center}.nfpa-diamond{width:124px;height:124px;position:relative;transform:rotate(45deg);margin:8px}.nfpa-cell{position:absolute;width:60px;height:60px;display:grid;place-items:center;border:2px solid #000;font-weight:900;font-size:1rem;background:#fff;color:#000}.nfpa-cell span{transform:rotate(-45deg)}.nfpa-health{left:0;top:32px}.nfpa-fire{left:32px;top:0}.nfpa-reactivity{right:0;top:32px}.nfpa-special{left:32px;bottom:0}.sds-section-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.panel h2{font-size:1.15rem;margin:0 0 8px}.panel p{line-height:1.45;color:#d8d8d8}.summary-list{display:grid;gap:0;margin:0}.summary-list div{padding:8px 0;border-bottom:1px solid var(--line)}.summary-list dt{font-weight:900;color:#fff}.summary-list dd{margin:3px 0 0;color:var(--muted)}.form-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.label{display:grid;gap:6px;font-weight:800;color:#fff}.label span{color:var(--muted);font-weight:400}.label-full{grid-column:1/-1}.banner{background:#0d0d0d;border:1px solid var(--line2);border-radius:12px;padding:12px;margin:10px 0;color:#fff}.footer{background:#050505;border-top:1px solid var(--line)}.footer-inner{padding:18px 16px;color:var(--muted);font-size:.9rem}@media(max-width:820px){.emergency-strip-inner,.search-row,.incident-grid,.hazard-overview,.sds-section-grid,.form-grid{grid-template-columns:1fr}.section-heading,.filter-toolbar,.detail-header{display:block}.detail-actions{margin-top:12px}.sort-control{margin-top:8px}.hero-inner{padding:14px 16px}.topbar-inner{align-items:flex-start;flex-direction:column}}
  `;
