(() => {
  ...
  style.textContent = `
    ...
    html, body {
      background: var(--sojo-bg) !important;
      color: var(--sojo-text) !important;
    }
    ...
    .shell {
      background:
        radial-gradient(circle at 90% 2%, rgba(45, 102, 255, .13), transparent 34%),
        linear-gradient(180deg, #05070b 0%, #070a10 100%) !important;
    }

    .topbar {
      background: rgba(5, 7, 11, .94) !important;
      border-bottom: 1px solid var(--sojo-line) !important;
      backdrop-filter: blur(14px) !important;
    }

    .brand-mark {
      background: var(--sojo-blue) !important;
    ...
    .lead,
    .sort-control {
      color: var(--sojo-muted-2) !important;
    }
    ...
    .filter-chip {
      ...
      color: var(--sojo-text) !important;
      border-color: var(--sojo-line) !important;
    }
    ...
    .hero .eyebrow {
      ...
      color: var(--sojo-purple) !important;
      padding: 0 !important;
    ...
    .chemical-card,
    .detail-header {
      background: var(--sojo-panel) !important;
      border-color: var(--sojo-line) !important;
      box-shadow: none !important;
      color: var(--sojo-text) !important;
    }
    ...
    .filter-toolbar {
      border-bottom: 1px solid var(--sojo-line-soft) !important;
      padding-bottom: 12px !important;
    }
    ...
    .chemical-card {
      ...
      border-left: 0 !important;
      border-right: 0 !important;
      border-top: 1px solid var(--sojo-line) !important;
    ...
    .hazard-rail {
      width: 4px !important;
      background: var(--sojo-purple) !important;
    }

    .hazard-high .hazard-rail,
    .hazard-extreme .hazard-rail {
      background: #ff4d4d !important;
    }

    .hazard-moderate .hazard-rail {
    ...
    .card-footer {
      color: var(--sojo-muted) !important;
    }
    ...
    .incident-card,
    .sds-section-grid .panel,
    .hazard-overview .panel,
    .detail-header {
      border-radius: 16px !important;
      border: 1px solid var(--sojo-line) !important;
      background: var(--sojo-panel-soft) !important;
      padding: 18px !important;
    }

    .summary-list div {
      border-bottom-color: var(--sojo-line) !important;
    }
